...
REM
REM Generated by Vivado on Sun Feb 12 13:49:59 +0800 2023
...
echo "xvhdl --incr --relax -prj lab2_2_2_vhdl.prj"
call xvhdl  --incr --relax -prj lab2_2_2_vhdl.prj -log xvhdl.log
